...
//    elTmp := nil;
    ...
    elTest0 := elTest.get_element_by_id( 'test0' );
    assert( elTest0 <> nil );
    ...
    elBorder := elBody.get_element_by_id( 'border' );
    assert( elBorder <> nil );
    ...
    elScroll := elBody.get_element_by_id( 'scroll' );
    assert( elScroll <> nil );
