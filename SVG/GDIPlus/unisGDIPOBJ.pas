...
\**************************************************************************)
  ...
  public
    ...
    constructor CreateFromGraphics(Graphics: GPGraphics; Dummy: Integer = 0);
    destructor Destroy; override;
...
\**************************************************************************)
  ...
  begin
    SetStatus(GdipGetRegionHRgn(nativeRegion, g.FnativeGraphics, result));
  end;
  ...
  begin
    booln := FALSE;
    SetStatus(GdipIsEmptyRegion(nativeRegion, g.FnativeGraphics, booln));
    result := booln;
  end;
  ...
  begin
    booln := FALSE;
    SetStatus(GdipIsInfiniteRegion(nativeRegion, g.FnativeGraphics, booln));
    result := booln;
  end;
  ...
  begin
    booln := FALSE;
    if assigned(g) then gpx := g.FnativeGraphics else gpx := nil;
...
\**************************************************************************)
  ...
  constructor TGPGraphics.CreateFromGraphics(Graphics: GPGraphics; Dummy: Integer);
  begin
    SetNativeGraphics(Graphics);
  end;
  ...
  begin
    result := SetStatus(GdipSetPageUnit(FnativeGraphics,
                             unit_));
  end;

  function TGPGraphics.SetPageScale(scale: Single): TStatus;
  begin
    result := SetStatus(GdipSetPageScale(FnativeGraphics,
                              scale));
  end;
  ...
  begin
    result := SetStatus(GdipDrawLines(FnativeGraphics,
                           pen.nativePen,
                           points, count));
  end;
  ...
  begin
    result := SetStatus(GdipDrawLinesI(FnativeGraphics,
                            pen.nativePen,
                            points,
                            count));
  end;
  ...
  begin
    result := SetStatus(GdipDrawArc(FnativeGraphics,
                         pen.nativePen,
                         x,
                         y,
                         width,
  ...
  begin
    result := SetStatus(GdipDrawBeziers(FnativeGraphics,
                             pen.nativePen,
                             points,
                             count));
  end;
  ...
  begin
    result := SetStatus(GdipDrawRectangles(FnativeGraphics,
                            pen.nativePen,
                            rects, count));
  end;
  ...
  begin
    result := SetStatus(GdipDrawEllipseI(FnativeGraphics,
                              pen.nativePen,
                              x,
                              y,
                              width,
  ...
  begin
    result := SetStatus(GdipDrawPolygon(FnativeGraphics,
                             pen.nativePen,
                             points,
                             count));
  end;
  ...
  begin
    result := SetStatus(GdipDrawPolygonI(FnativeGraphics,
                              pen.nativePen,
                              points,
                              count));
  end;
  ...
  begin
    ...
    result := SetStatus(GdipDrawPath(FnativeGraphics, nPen, nPath));
  end;
  ...
  begin
    result := SetStatus(GdipDrawCurveI(FnativeGraphics,
                            pen.nativePen,
                            points,
                            count));
  end;
  ...
  function TGPGraphics.DrawCurve(pen: TGPPen; points: PGPPoint; count, offset,
           numberOfSegments: Integer; tension: Single = 0.5): TStatus; 
  begin
    result := SetStatus(GdipDrawCurve3I(FnativeGraphics,
                             pen.nativePen,
                             points,
                             count,
                             offset,
  ...
  begin
    ...
    result := SetStatus(GdipDrawImage(FnativeGraphics, nImage, x, y));
  end;
  ...
  begin
    if assigned(Image) then nImage := Image.nativeImage else nImage := nil;
    result := SetStatus(GdipDrawImageI(FnativeGraphics,
                            nimage,
                            x,
                            y));
  end;
  ...
  begin
    result := SetStatus(GdipSetClipHrgn(FnativeGraphics, hRgn,
                             combineMode));
  end;
  ...
  begin
    result := SetStatus(GdipTranslateClipI(FnativeGraphics,
                            dx, dy));
  end;

  function TGPGraphics.GetClip(region: TGPRegion): TStatus;
  begin
    result := SetStatus(GdipGetClip(FnativeGraphics,
                         region.nativeRegion));
  end;
  ...
  begin
    booln := FALSE;
    SetStatus(GdipIsClipEmpty(FnativeGraphics, @booln));
    result := booln;
  end;
  ...
  begin
    booln := FALSE;
    SetStatus(GdipIsVisibleClipEmpty(FnativeGraphics, booln));
    result := booln;
  end;
  ...
  begin
    booln := FALSE;
    SetStatus(GdipIsVisiblePointI(FnativeGraphics,
                          point.X,
                          point.Y,
                          booln));
    result := booln;
  ...
  begin
    booln := TRUE;
    SetStatus(GdipIsVisibleRectI(FnativeGraphics,
                         X,
                         Y,
                         Width,
                         Height,
  ...
  begin
    booln := FALSE;
    SetStatus(GdipIsVisiblePoint(FnativeGraphics,
                         X,
                         Y,
                         booln));
  ...
  begin
    booln := TRUE;
    SetStatus(GdipIsVisibleRect(FnativeGraphics,
                        X,
                        Y,
                        Width,
                        Height,
...
\**************************************************************************)
  ...
  begin
    if assigned(g) then nGraphics := g.FnativeGraphics else nGraphics := nil;
  ...
  var ngraphics: Gpgraphics;
  begin
    if assigned(graphics) then ngraphics := graphics.FnativeGraphics else ngraphics := nil;
...
\**************************************************************************)
  ...
  begin
    booln := FALSE;
    nativeGraphics := nil;
    if assigned(g) then nativeGraphics := g.FnativeGraphics;
